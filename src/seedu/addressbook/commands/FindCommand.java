...
public class FindCommand extends Command {
    ...
    private List<ReadOnlyPerson> getPersonsWithNameContainingAnyKeyword(Set<String> keywords) {
        ...
        Set<String> keywordsLowerCase = nameToLowerCase(keywords);
        for (ReadOnlyPerson person : addressBook.getAllPersons()) {
            Set<String> wordsInName = new HashSet<>(person.getName().getWordsInName());
            final Set<String> wordsInNameLowerCase = nameToLowerCase(wordsInName);
    ...
    /**
     * Changes names in a set to lowercase
     */
    private Set<String> nameToLowerCase(Set<String> names){
